<?php
include '../online-learning_database/model/database.php';
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <nav class="course-tabs">
                        <div class="nav nav-tabs border-0" id="nav-tab" role="tablist">
                            ...
                            <button class="nav-link" id="course-instructor-tab" data-bs-toggle="tab"
                                ...
                                aria-controls="course-instructor" aria-selected="false">Thông tin GV</button>
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="course-instructor" role="tabpanel"
                            ...
                            <div class="course-instructor box">
                                <h3 class="text-capitalize mb-3">Giảng viên</h3>
